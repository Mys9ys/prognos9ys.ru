...
**Этап 4:** докупка коллекций до 16/32/48 с биржи (`AlbumCollectionBuyService`); модератор «Крафт ×5» — готово.

**Этап 5:** Premium-прогноз — рандом и правка 30 мин (`FootballPrognosisEditService`, `aa3a15f`) — готово.
