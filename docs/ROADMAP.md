...
| ~~[ ]~~ | ~~В списке матчей — лучшие прогнозы / все прогнозы~~ | — | снято с плана (2026-07) |
...
| [x] | **Банки и кредиты** | C+ | открытие от **250** 💵 (резерв **200**), вклад от **100**, займ от **50**, **7%** / **15%** за **5** матчей ЧМ; частные банки игроков |
| [x] | Ачивки v1 | C | welcome, счётчик прогнозов, ЧМ |
| [ ] | Комната болельщика / усадьба | D | стенд, просмотры, лайки; биржа = MVP «гос. аукциона» |
| [x] | Открытие сундучков (уровень, ачивки, WC26) + биржа | E | `ChestOpenService`, `ExchangeService` |
