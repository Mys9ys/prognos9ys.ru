        ...
        <div class="promo_template_wrapper">
            <div class="promo_template_title_block">
                <div class="promo_template_title_block_logo">
                    <a href="/">
                        <img class="promo_template_title_block_logo_img" src="/local/templates/dryclean_new/images/logo-diana-white.svg" alt="" >
                    </a>
                </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div id="promo_block_2" class="swiper-slide promo_slide_box promo_slide_box_prizes">
                        <div class="promo_slide_title_box">
                            ...
                            <div class="promo_slide_title_description">Больше квитанций - выше шанс на выигрыш</div>
                        </div>
                        <div class="promo_slide_body promo_slide_body_prizes promo_prize_slider owl-carousel">
...
<!--                                <form id="form_search_winner" action="--><?//=POST_FORM_ACTION_URI?><!--" method="post">-->
                                    <input type="text" class="promo_winner_search promo_order_mask" placeholder="Поиск по номеру квитанции">
<!--                                </form>-->
                        ...
                        <div id="table_winners">
                            ...
                            <div class="promo_slide_body promo_slide_body_winners">
                                <div class="promo_slide_body_table_wrapper">
                                    ...
                                    <table class="promo_slide_winners_tab">
                                        ...
                                        <?foreach ($arResult['winners'] as $key=>$winner){?>
                                            <tr class="promo_winner_item">
                                                ...
                                                <td class="promo_item_order"><span>Номер квитанции</span><?=$winner['order']?></td>
                                    ...
                                    <?}else{?>
                                        <div style="color:rgb(255,255,255); padding-top: 20px; text-align:left;">Победители будут опубликованы в конце розыгрыша.</div>
                                    <?}?>
                                </div>
                            </div>
                            <?
            ...
            ?>
                ...
                <div class="promo_form_row">
                    <label class="promo_label_form promo_label_form_other promo_label_mobile_margin" for="order">
                        № квитанции (11/12 цифр)
                        <input type="text" name="order" class="promo_form_modal_input input_one promo_order_mask" placeholder="123456789012" value="<?=$arResult['VALUES']['order']?>">
