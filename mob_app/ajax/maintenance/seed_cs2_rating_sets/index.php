...
require_once $_SERVER['DOCUMENT_ROOT'] . '/local/tools/seed_cs2_team_rating_sets.php';
...
try {
    $eventId = (int)($_GET['event'] ?? $_POST['event'] ?? 0);
    $result = seed_cs2_team_rating_sets($eventId, false);
