        ...
        <div class="accordion" id="accordionExample">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                     data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <p>Верхний блок – предпочтительнее для заполнения с компьютера.</p>
                       ...
                       <p> <i class="bi bi-file-fill"></i>(карточки – желтые и красные)б #9873;(угловые), pen(пенальти) – проставляются участником – пустые поля означают что данное событие проигнорировано
                       </p>
                        
                       <p> %(процент владения мячом) – заполняется только верхнее поле – бегунок и нижнее значение вычисляются из верхнего</p>

                        <p>Нижний блок – упрощенный ввод для мобильной версии сайта</p>
