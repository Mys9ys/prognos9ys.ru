...
try {
    ...
    $result = array_merge(
        $installer->upgradeCollectionAlbumHl(),
        $installer->upgradeLearnedRecipesHl()
    );
    echo 'Collection album HL installed: ' . json_encode($result, JSON_UNESCAPED_UNICODE) . PHP_EOL;
} catch (Throwable $e) {
